  ...
  return (
    <div className="bg-card border border-border rounded-xl p-3 md:p-6">
      ...
      <div className="flex items-center gap-2 md:gap-4 mb-4">
        ...
        <div>
          <h4 className="text-sm md:text-base font-semibold text-foreground">{auctioneer.name}</h4>
      ...
      <div className="flex gap-2">
        <Button variant="outline" className="flex-1 gap-2 text-xs md:text-sm">
          <MessageCircle className="h-3 w-3 md:h-4 md:w-4" />
          Contact
        </Button>
        <Button variant="ghost" size="icon" className="text-xs md:text-sm">
