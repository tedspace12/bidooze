  ...
  return (
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between">
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">Auctions</h1>
          ...
          <div className="flex-1">
            <div className={
              ...
              {paginatedAuctions.map((auction) => (
                <AuctionCard key={auction.id} auction={auction} isRegistered={auction.isRegistered} viewMode={viewMode} />
              ))}
            </div>

            {paginatedAuctions.length === 0 && (
              <div className="text-center py-16 bg-card border border-border rounded-xl">
                <p className="text-muted-foreground text-lg">No auctions match your filters.</p>
